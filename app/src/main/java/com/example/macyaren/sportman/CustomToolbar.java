...
public class CustomToolbar extends Toolbar {
	...
	protected TextView left_back;
	protected TextView center_title;
	protected TextView right_ti;
	protected RelativeLayout relativeLayout;

	protected int center_title_color;
	protected int center_title_size;
	protected Drawable left_imgResources;
	...
	* */
	protected void setCenter_title_attrs(String string) {
		if (string != null) {
	...
	* */
	protected void setCenter_title_attrs(String string, float size) {
		if (string != null) {
			center_title.setText(string);
		}
		if (size != -1) {
	...
	* */
	protected void setCenter_title_attrs(String string, float size, int color) {
		if (string != null) {
			center_title.setText(string);
		}
		if (size != -1) {
	...
	* */
	protected void setLeft_back_image(int drawableID) {
	...
	* */
	protected void setRight_ti_attrs(String string) {
		if (string != null) {
	...
	* */
	protected void setRight_ti_attrs(String string, float size) {
		if (string != null) {
			right_ti.setText(string);
		}
		if (size != -1) {
	...
	* */
	protected void setRight_ti_attrs(String string, float size, int color) {
		if (string != null) {
			right_ti.setText(string);
		}
		if (size != -1) {
